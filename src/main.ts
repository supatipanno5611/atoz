...
export default class ATOZPlugin extends Plugin {
    ...
    registerCommands() {
        ...
        this.addCommand({ id: 'move-line-to-target', name: '현재 행을 파일로 이동', icon: 'lucide-archive-restore', editorCallback: (editor, view) => void this.later.moveLinesToLater(editor, view.file) });
